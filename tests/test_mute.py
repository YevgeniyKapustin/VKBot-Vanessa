...
def test_mute(chat_id, command, expect_response):
    with patch('main.Conversation._Conversation__members_search') as members_mock:
        members_mock.return_value = members
        with patch('main.Conversation._Conversation__victim_id_search') as victim_id_mock:
            victim_id_mock.return_value = '560930170'
            with patch('main.Conversation._Conversation__from_check') as from_check_mock:
